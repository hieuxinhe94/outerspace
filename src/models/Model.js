...
export default function Model({ pose, ...props }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <a.mesh receiveShadow position={[0, 0.75, 1]} scale={scale} onClick={() => {
            console.log('Picked this item');
      }}>
      
        <boxBufferGeometry args={[0.5, -0.2, 0.01]} >
        <Text opacity={0.75} size={0.1} color="#1A1E2A" position={[0, 0, 1]}>
            AAAAAAAAA
          </Text>
             </boxBufferGeometry>

...
import { useGLTF, Html, TransformControls, Environment, ContactShadows } from '@react-three/drei'
...
export default function DirectionMarker({...props}) {
  return (
    <Suspense fallback={<Html center className="loading" children="Marker" />} > 
    <group position={[-2.5, 1, -3.5]} scale={0.25}>
